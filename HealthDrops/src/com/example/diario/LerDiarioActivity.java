...
public class LerDiarioActivity extends ListActivity {  
	String[] out;
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    out =  manager.ler("logs").split("DIV");
	    ...
	    // colocar na listView
	    setListAdapter(new ArrayAdapter<String>(this,R.layout.activity_ler_diario, output)); 
